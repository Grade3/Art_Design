...
public class ArtistController {
	...
	public Map<String, Object> JsonGetPageArtist(@RequestParam(value = "page") int page,
		...
		List<Customer> list = artistService.GetPageBeanFilter(Customer.class, page, pageSize, selectname, value);
		int total = artistService.GetPageBeanFilterTotal(Customer.class, page, pageSize, selectname, value);
	...
	public String JsonDeleteUser(@RequestParam(value = "ids") String ids) {
		...
		for (int i = 0; i < id.length; i++) {
			...
			Customer customerBean = artistService.GetEntityById(Customer.class, temp[i]);
	...
	public Map<String, Object> JsonGetArtists(@RequestParam(value = "page") Integer page,
			@RequestParam(value = "pageSize") Integer pageSize) {
		Map<String, Object> map = new HashMap<String, Object>();
		List<Customer> list = artistService.GetPageBeanFilter(Customer.class, page, pageSize, CustomerTable.ISARTIST,
				1 + "");
		int total = artistService.GetPageBeanFilterTotal(Customer.class, page, pageSize, CustomerTable.ISARTIST,
				1 + "");
