...
<div class="container-fluid mainer">
	<form action="<%=basePath%>product.do?method=PublishProduct" enctype="multipart/form-data" method="post">
	<div class="row">
	...
	<div class="row password_error">
		<input type="submit" value="确认发布" class="col-xs-12 btn_submit" onclick="return validate()"/>
	</div>
	</form>
</div>
