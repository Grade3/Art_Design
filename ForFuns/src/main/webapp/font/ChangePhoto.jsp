...
<div class="container-fluid header">
	<div class="title_bar">
		...
		<p><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;修改头像</p>
	</div>
</div>
		...
		<tbody>
			...
			<tr>
				<td class="table_btn">
					...
					<input type="button" value="选择图片" class="btn_change" onclick="file_change_photo()" />
				</td>
			</tr>
			<tr>
				<td class="table_submit">
					<input type="submit" value="确认修改" class="btn_change btn_submit" />
				</td>
			</tr>
		</tbody>
	</table>
